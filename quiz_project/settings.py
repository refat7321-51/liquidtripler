...
CSP_SCRIPT_SRC = ("'self'", "'unsafe-inline'", "'unsafe-eval'", "https://cdn.jsdelivr.net", "https://cdn.vercel-insights.com")
...
CSP_CONNECT_SRC = ("'self'", "https://vitals.vercel-insights.com")
